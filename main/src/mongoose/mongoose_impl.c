...
struct attribute s_modbInverter_attributes[] = {
  ...
  {"I10_LoadUsedHoyMux", "int", NULL, offsetof(struct modbInverter, I10_LoadUsedHoyMux), 0, false},
  ...
  {"I9_BatDscHoyMux", "int", NULL, offsetof(struct modbInverter, I9_BatDscHoyMux), 0, false},
  ...
  {"I8_BatChdHoyMux", "int", NULL, offsetof(struct modbInverter, I8_BatChdHoyMux), 0, false},
  ...
  {"I7_LoadUsedTotalMux", "int", NULL, offsetof(struct modbInverter, I7_LoadUsedTotalMux), 0, false},
  ...
  {"I6_UsedkwhHoyMux", "int", NULL, offsetof(struct modbInverter, I6_UsedkwhHoyMux), 0, false},
  ...
  {"I5_GenkWhHoyMux", "int", NULL, offsetof(struct modbInverter, I5_GenkWhHoyMux), 0, false},
...
struct attribute s_modbSensors_attributes[] = {
  ...
  {"humMux", "int", NULL, offsetof(struct modbSensors, humMux), 0, false},
  ...
  {"AMux", "int", NULL, offsetof(struct modbSensors, AMux), 0, false},
  ...
  {"PHMux", "int", NULL, offsetof(struct modbSensors, PHMux), 0, false},
  ...
  {"DOMux", "int", NULL, offsetof(struct modbSensors, DOMux), 0, false},
...
struct attribute s_modbBattery_attributes[] = {
  ...
  {"tempMux", "int", NULL, offsetof(struct modbBattery, tempMux), 0, false},
  ...
  {"cycleMux", "int", NULL, offsetof(struct modbBattery, cycleMux), 0, false},
  ...
  {"SOHMux", "int", NULL, offsetof(struct modbBattery, SOHMux), 0, false},
  ...
  {"SOCMux", "int", NULL, offsetof(struct modbBattery, SOCMux), 0, false},
...
struct attribute s_modbPanels_attributes[] = {
  ...
  {"PV2AmpsMux", "int", NULL, offsetof(struct modbPanels, PV2AmpsMux), 0, false},
  ...
  {"PV2VMux", "int", NULL, offsetof(struct modbPanels, PV2VMux), 0, false},
  ...
  {"PV1AmpsMux", "int", NULL, offsetof(struct modbPanels, PV1AmpsMux), 0, false},
  ...
  {"PV1VMux", "int", NULL, offsetof(struct modbPanels, PV1VMux), 0, false},
  ...
  {"ChargeMux", "int", NULL, offsetof(struct modbPanels, ChargeMux), 0, false},
