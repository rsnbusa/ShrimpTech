...
#define CONFIG_NMEA_STATEMENT_GGA
#define CONFIG_NMEA_STATEMENT_GSA
#define CONFIG_NMEA_STATEMENT_GSV
#define CONFIG_NMEA_STATEMENT_RMC
#define CONFIG_NMEA_STATEMENT_GLL
#define CONFIG_NMEA_STATEMENT_VTG
