...
// schematic is for hal-Shrimp-602-2L-1MB-TVL-V2 (EasyEDA project name)
...
// RS485 GPIOs
#define RS485TX                         (18)         //GPIO for RS485 RX actually TX but labeled RX on schematic for some reason
#define RS485RX                         (8)        //GPIO for RS485 RX
...
#define HXDOUT                          (47)        // GPIO for HX711 data output uses SCL Schematic pin for data output
#define HXCLK                           (21)        // GPIO for HX711 clock uses SDA schematic pin for clock
