...
struct attribute s_modbInverter_attributes[] = {
  ...
  {"I11_BatTempMux", "double", NULL, offsetof(struct modbInverter, I11_BatTempMux), 0, false},
  ...
  {"I11_BatTempOff", "int", NULL, offsetof(struct modbInverter, I11_BatTempOff), 0, false},
