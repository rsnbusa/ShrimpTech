#ifndef TYPESnetif_H_
#define TYPESnetif_H_
...
static esp_err_t mesh_netif_transmit_from_root_ap(void *h, void *buffer, size_t len)
{
    ...
    mesh_netif_driver_t mesh_driver = (mesh_netif_driver_t)h;
...
{
    mesh_netif_driver_t driver =(mesh_netif_driver_t ) args;
...
{
    mesh_netif_driver_t driver = (mesh_netif_driver_t )calloc(1, sizeof(struct mesh_netif_driver));
    if (driver == NULL) {
